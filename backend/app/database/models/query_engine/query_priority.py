...
class QueryPriority(Base, TimestampMixin):
    __tablename__ = 'query_priorities'
    ...
    queries: Mapped[list['Query']] = relationship(
        ...
        foreign_keys='[Query.priority_id]',
    )

    def __repr__(self) -> str:
        return f"<QueryPriority(priority_id={self.priority_id}, priority_code={self.priority_code})>"
