...
async def upload_document(file: UploadFile = File(...), user_id: str = Form(default="local-user"), document_service: DocumentService = Depends( get_document_service)) -> UploadResponse:
    try:
